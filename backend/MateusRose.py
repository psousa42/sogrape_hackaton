...
db = client["sogrape"]
collection = db["MateusRose"]

link = "https://www.continente.pt/produto/mateus-vinho-rose-mateus-2050174.html"
...
###GARRAFEIRA SOARES###
link = "https://www.garrafeirasoares.pt/pt/portugal/vinhos/vinho-rose-mateus-75-cl/item_10807.html"
headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36'}
response = requests.get(link, headers=headers)
...
###ELCORTEINGLES###
link = "https://www.elcorteingles.pt/supermercado/0105218714000033-mateus-vinho-rose-garrafa-75-cl/"
headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36'}
response = requests.get(link, headers=headers)
