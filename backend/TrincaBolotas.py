...
db = client["sogrape"]
collection = db["TrincaBolotas"]

link = "https://www.continente.pt/produto/trinca-bolotas-regional-alentejano-vinho-tinto-trinca-bolotas-5471317.html"
...
###GARRAFEIRA SOARES###
link = "https://www.garrafeirasoares.pt/pt/portugal/vinhos/vinho-tinto-trinca-bolotas-75-cl/item_10039.html"
...
###ELCORTEINGLES###
link = "https://www.elcorteingles.pt/supermercado/0105218722001098-trinca-bolotas-vinho-tinto-regional-do-alentejo-garrafa-75-cl/"
headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36'}
response = requests.get(link, headers=headers)
